...
GL_ALL(glTexParameterf); AS_ALL(glTextureParameterf, glTexParameterf);
GL_ALL(glTexParameterfv); AS_ALL(glTextureParameterfv, glTexParameterfv);
GL_ALL(glTexParameteri); AS_ALL(glTextureParameteri, glTexParameteri);
GL_ALL(glTexParameteriv); AS_ALL(glTextureParameteriv, glTexParameteriv);
GL_ALL(glUniform1f);
GL_ALL(glUniform1fv);
GL_ALL(glUniform1i);
GL_ALL(glUniform1iv);
...
GLIN_ALL(glVertexAttribLPointer);
...
GL_ALL(glColorMaski);
AS_MAP(glColorMaskIndexed, glColorMaski);
GL_ALL(glIsEnabledi);
...
GL_ALL(glTexParameterIiv); AS_ALL(glTextureParameterIiv, glTexParameterIiv);
GL_ALL(glTexParameterIuiv); AS_ALL(glTextureParameterIuiv, glTexParameterIuiv);
