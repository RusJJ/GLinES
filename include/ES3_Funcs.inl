...
GL_ALL(glBindBuffer);
GL_ALL(glBindFramebuffer);
GL_ALL(glBindRenderbuffer);
GL_ALL(glBindTexture);
GL_ALL(glBlendColor);
...
GL_ALL(glDrawRangeElementsBaseVertex);
...
GL_MAP(glBindVertexArrayOES);
GL_MAP(glDeleteVertexArraysOES);
GL_MAP(glGenVertexArraysOES);
GL_MAP(glIsVertexArrayOES);
// AMD
...
// EXT
GL_MAP(glEGLImageTargetTexStorageEXT);
GL_MAP(glBindFragDataLocationIndexedEXT);
GL_MAP(glBindFragDataLocationEXT);
GL_MAP(glGetProgramResourceLocationIndexEXT);
GL_MAP(glGetFragDataIndexEXT);
GL_MAP(glBufferStorageEXT);
GL_MAP(glClipControlEXT);
GL_MAP(glCopyImageSubDataEXT);
GL_MAP(glLabelObjectEXT);
GL_MAP(glGetObjectLabelEXT);
GL_MAP(glInsertEventMarkerEXT);
GL_MAP(glPushGroupMarkerEXT);
GL_MAP(glPopGroupMarkerEXT);
GL_MAP(glDiscardFramebufferEXT);
GL_MAP(glGenQueriesEXT);
GL_MAP(glDeleteQueriesEXT);
GL_MAP(glIsQueryEXT);
GL_MAP(glBeginQueryEXT);
GL_MAP(glEndQueryEXT);
GL_MAP(glQueryCounterEXT);
GL_MAP(glGetQueryivEXT);
GL_MAP(glGetQueryObjectivEXT);
GL_MAP(glGetQueryObjectuivEXT);
GL_MAP(glGetQueryObjecti64vEXT);
GL_MAP(glGetQueryObjectui64vEXT);
GL_MAP(glEnableiEXT);
GL_MAP(glDisableiEXT);
GL_MAP(glBlendEquationiEXT);
GL_MAP(glBlendEquationSeparateiEXT);
GL_MAP(glBlendFunciEXT);
GL_MAP(glBlendFuncSeparateiEXT);
GL_MAP(glColorMaskiEXT);
GL_MAP(glIsEnablediEXT);
GL_MAP(glBufferStorageExternalEXT);
GL_MAP(glFramebufferTextureEXT);
GL_MAP(glGetUnsignedBytevEXT);
GL_MAP(glGetUnsignedBytei_vEXT);
GL_MAP(glDeleteMemoryObjectsEXT);
GL_MAP(glIsMemoryObjectEXT);
GL_MAP(glCreateMemoryObjectsEXT);
GL_MAP(glMemoryObjectParameterivEXT);
GL_MAP(glGetMemoryObjectParameterivEXT);
GL_MAP(glTexStorageMem2DEXT);
GL_MAP(glTexStorageMem2DMultisampleEXT);
GL_MAP(glTexStorageMem3DEXT);
GL_MAP(glTexStorageMem3DMultisampleEXT);
GL_MAP(glBufferStorageMemEXT);
GL_MAP(glImportMemoryFdEXT);
GL_MAP(glRenderbufferStorageMultisampleEXT);
GL_MAP(glFramebufferTexture2DMultisampleEXT);
GL_MAP(glPrimitiveBoundingBoxEXT);
GL_MAP(glGetGraphicsResetStatusEXT);
GL_MAP(glReadnPixelsEXT);
GL_MAP(glGetnUniformfvEXT);
GL_MAP(glGetnUniformivEXT);
GL_MAP(glPatchParameteriEXT);
GL_MAP(glTexParameterIivEXT);
GL_MAP(glTexParameterIuivEXT);
GL_MAP(glGetTexParameterIivEXT);
GL_MAP(glGetTexParameterIuivEXT);
GL_MAP(glSamplerParameterIivEXT);
GL_MAP(glSamplerParameterIuivEXT);
GL_MAP(glGetSamplerParameterIivEXT);
GL_MAP(glGetSamplerParameterIuivEXT);
GL_MAP(glTexBufferEXT);
GL_MAP(glTexBufferRangeEXT);
// EXT (as ...)
...
AS_MAP(glGenQueries, glGenQueriesEXT);
AS_MAP(glDeleteQueries, glDeleteQueriesEXT);
AS_MAP(glIsQuery, glIsQueryEXT);
AS_MAP(glBeginQuery, glBeginQueryEXT);
AS_MAP(glEndQuery, glEndQueryEXT);
AS_MAP(glQueryCounter, glQueryCounterEXT);
AS_MAP(glGetQueryiv, glGetQueryivEXT);
AS_MAP(glGetQueryObjectiv, glGetQueryObjectivEXT);
AS_MAP(glGetQueryObjectuiv, glGetQueryObjectuivEXT);
...
AS_MAP(glBufferStorageExternal, glBufferStorageExternalEXT);
...
AS_MAP(glBufferStorageMem, glBufferStorageMemEXT);
