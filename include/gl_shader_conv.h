...
#define _SHADER_HEADER_SECOND                               \
        ...
        "#define gl_SecondaryColor GLIN_SecondaryColor\n"  \
        "#define gl_FrontColor GLIN_FrontColor\n"          \
        "#define gl_BackColor GLIN_BackColor\n"            \
        "#define gl_FrontSecondaryColor GLIN_FrontSecondaryColor\n" \
        "#define gl_BackSecondaryColor GLIN_BackSecondaryColor\n" \
